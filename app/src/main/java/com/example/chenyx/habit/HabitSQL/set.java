...
public class set {
    ...
    int  calendars[][][]=new int[2][4][31];
    int  strength [][][]=new int[2][4][31];
    String [][][]Xline=new String[2][4][31];
    ...
    private void initLineChart(){
        ...
        line.setStrokeWidth(4);//线条的粗细，默认是3
            ...
            for (int j=0;j<4;j++)
            {
                for(int k=0;k<31;k++)
                {
                    ...
                    if(calendars[i][j][k]==1)
                    {
                        ...
                        if (k==0&&j==0)
                        {
                            strength[i][j][k]=strength[i-1][3][30]+6;
                            if (strength[i][j][k]>100)
                            {
                                strength[i][j][k]=100;
                            }
                    ...
                    if (calendars[i][j][k]==0) {
                        ...
                        if (i == 1) {
                            ...
                            if (k == 0 && j == 0) {
                                strength[i][j][k] = strength[i - 1][3][30] -3;
                                if (strength[i][j][k] <0) {
                                    strength[i][j][k] = 0;
                                }
                            }
        ...
        for(i=0;i<2;i++)
        {
            for(j=0;j<4;j++)
            {
                for(k=0;k<31;k++)
                {
                    ...
                    if (i==0){
                        Xline[i][j][k]=Integer.toString(j+9)+"/"+Integer.toString(k+1)+" ";
                        if (j==0&&k==0)
                        {
                            Xline[i][j][k]=Integer.toString(i+2018)+"/"+Integer.toString(j+9);
                        }
                    }
                    if (i==1){
