...
public class MyBaseAdapter extends BaseAdapter {
    ...
    public MyBaseAdapter(Context context,Habit habit)
    {
    ...
    public void get_list()  //每当打卡时重新调用,并刷新适配器
    {
        ...
        HabitManager habitManager=habit.get_manager();
        Cursor cursor=habitManager.find_all();
        ...
        while (cursor.moveToNext())
        {
            if (judge==false)
            {
                start=new SignData(Long.parseLong(cursor.getString(0)),
            ...
            else
            {
                ...
                {
                    end=new SignData(Long.parseLong(cursor.getString(0)),
                            Integer.parseInt(cursor.getString(1)),
                            Integer.parseInt(cursor.getString(2)),
                            Integer.parseInt(cursor.getString(3)),
                            Integer.parseInt(cursor.getString(4)));
